...
namespace DataTableConverter.Classes
{
    class DetectTextEncoding
    {
        ...
        internal System.Text.Encoding GetEncoding(Encoding encoding)
        {
            ...
            switch (encoding)
            {
                ...
                case Encoding.Utf16BeBom:
                case Encoding.Utf16BeNoBom:
                case Encoding.Utf16LeBom:
                case Encoding.Utf16LeNoBom:
                    result = System.Text.Encoding.GetEncoding("UTF-16");
                    break;
